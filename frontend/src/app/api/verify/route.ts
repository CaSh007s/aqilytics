    ...
    await resend.emails.send({
      ...
      html: `
          ...
          <p style="margin-top: 20px; font-size: 12px; color: #666;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://aqilytics.vercel.app"}/api/unsubscribe?token=${subscriber.verification_token}" style="color: #666; text-decoration: underline;">
